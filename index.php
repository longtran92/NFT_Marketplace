...
<body>
          ...
          <div class="bannerTxt-container">
            ...
            <div class="banner-card">
              ...
              <div class="card-footer">
                <h5 class="footer-heading">Space Walking</h5>
                <div class="artist-tag">
                  <img src="./images/Homepage/artist-avatar-banner.png" alt="" class="artist-avatar">
                  <span class="artist-name">Animakid</span>
                </div>
              </div>
            </div>
            <button class="btn-primary btn-getStarted">
            ...
            <div class="statistics-container">
              <div class="stat">
                <span class="stat-number">240k+ </span>
                <span class="stat-txt">Total Sale</span>
              </div>
              <div class="stat">
                <span class="stat-number">100k+ </span>
                <span class="stat-txt">Auctions</span>
              </div>
              <div class="stat">
                <span class="stat-number">240k+ </span>
                <span class="stat-txt">Artists</span>
              </div>
            </div>
  ...
  <section class="trendingCollection-section">
    <div class="container">
      <div class="trendingCollection-content">
        <h3 class="section-heading">Trending Collection</h3>
        <p class="section-subHeading">Checkout our weekly updated trending collection.</p>
        <div class="collectionCards-container">
          <div class="collection-card">
            <img src="./images/Homepage/trending-section/animal-main.png" alt="" class="primary-img">
            <div class="secondaryImg-container">
              <img src="./images/Homepage/trending-section/animal-sub1.png" alt="" class="secondary-img">
              <img src="./images/Homepage/trending-section/animal-sub2.png" alt="" class="secondary-img">
              <div class="secondary-img full-collection">1025+</div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">DSGN Animals</h5>
              <div class="artist-tag">
                <img src="./images/Homepage/trending-section/avatar-1.png" alt="" class="artist-avatar">
                <span class="artist-name">MrFox</span>
              </div>
            </div>

          </div>
          <div class="collection-card">
            <img src="./images/Homepage/trending-section/mushroom-main.png" alt="" class="primary-img">
            <div class="secondaryImg-container">
              <img src="./images/Homepage/trending-section/mushroom-sub1.png" alt="" class="secondary-img">
              <img src="./images/Homepage/trending-section/mushroom-sub2.png" alt="" class="secondary-img">
              <div class="secondary-img full-collection">1025+</div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">Magic Mushrooms</h5>
              <div class="artist-tag">
                <img src="./images/Homepage/trending-section/avatar-2.png" alt="" class="artist-avatar">
          ...
          <div class="collection-card">
            <img src="./images/Homepage/trending-section/machine-main.png" alt="" class="primary-img">
            <div class="secondaryImg-container">
              <img src="./images/Homepage/trending-section/machine-sub1.png" alt="" class="secondary-img">
              <img src="./images/Homepage/trending-section/machine-sub2.png" alt="" class="secondary-img">
              <div class="secondary-img full-collection">1025+</div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">Disco Machines</h5>
              <div class="artist-tag">
                <img src="./images/Homepage/trending-section/avatar-3.png" alt="" class="artist-avatar">
                <span class="artist-name">BeKind2Robots</span>
              </div>
            </div>
    ...
    <div class="container">
      <div class="section-content">
        <div class="section-header">
          <div class="txt-container">
            <h3 class="section-heading">Top Creators</h3>
            <span class="section-subHeading">Checkout Top Rated Creators on the NFT Marketplace</span>
          </div>
          <button class="btn-primary btn-ranking">
        ...
        <div class="cards-container">
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-1.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Keepitreal</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
            </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-2.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">DigiLab</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-3.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">GravityOne</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-4.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Juanie</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-5.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">BlueWhale</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-6.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Mr Fox</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-7.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Shroomie</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-8.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Robotica</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-9.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">RustyRobot</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            ...
            <img src="./images/Homepage/top-creators/avatar-10.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Animakid</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            <div class="ranking-number">11</div>
            <img src="./images/Homepage/top-creators/avatar-11.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Dotgu</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
          ...
          <div class="card">
            <div class="ranking-number">12</div>
            <img src="./images/Homepage/top-creators/avatar-12.png" alt="" class="artist-avatar">
            <div class="artist-info">
              <h5 class="artist-name">Ghiblier</h5>
              <div class="total-sales">
                <span class="title">Total Sales:</span>
                <span class="amount">34.53 ETH</span>
              </div>
  ...
  <section class="browseCategories-section">
    <div class="container">
      <div class="section-content">
        <h3 class="section-heading">Browse Categories</h3>
        <div class="cards-container">
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-1.png" alt="">
              </div>
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M51.9531 35.3906C57.246 38.3777 61.6223 42.754 64.6094 48.0469" stroke="white"
                    stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">Art</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-2.png" alt="">
              </div>
              <div class="icon">
            ...
            <div class="card-footer">
              <h5 class="footer-heading">Collectibles</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-3.png" alt="">
              </div>
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                  ...
                  <path
                    ...
                    stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M81.25 31.25L31.25 43.75" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M31.25 79.6875V25L81.25 12.5V67.1875" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
              </div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">Music</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-4.png" alt="">
              </div>
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div class="card-footer">
              <h5 class="footer-heading">Photography</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-5.png" alt="">
              </div>
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M71.875 43.75L93.75 31.25V68.75L71.875 56.25" stroke="white" stroke-width="3"
                    stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">Video</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-6.png" alt="">
              </div>
              <div class="icon">

                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M84.375 50V68.75" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M75 59.375H93.75" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M32.8125 15.625V31.25" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M25 23.4375H40.625" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M65.625 71.875V84.375" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M59.375 78.125H71.875" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path
                    ...
                    stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M56.25 31.25L68.75 43.75" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
            ...
            <div class="card-footer">
              <h5 class="footer-heading">Utility</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-7.png" alt="">
              </div>
              <div class="icon">
                <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                  ...
                  <path
                    ...
                    stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M12.5 50H87.5" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M50 12.5V87.5" stroke="white" stroke-width="3" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
              </div>
            </div>
            <div class="card-footer">
              <h5 class="footer-heading">Sport</h5>
            </div>
          </div>
          <div class="card">
            <div class="image-icon">
              <div class="image">
                <img src="./images/Homepage/browse-categories/card-8.png" alt="">
              </div>
              <div class="icon">
            ...
            <div class="card-footer">
              <h5 class="footer-heading">Virtual Worlds</h5>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="discover-section">
    <div class="container">
      <div class="section-content">
        <div class="section-header">
          <div class="txt-container">
            <h3 class="section-heading">Discover More NFTs</h3>
            <span class="section-subHeading">Explore new trending NFTs</span>
          </div>
          <button class="btn-primary btn-seeAll">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M2.83931 6.74556C4.3292 5.25567 6.66714 3.75 10 3.75C13.3329 3.75 15.6708 5.25567 17.1607 6.74556C17.9038 7.4887 18.4397 8.23076 18.7906 8.78809C18.9664 9.06724 19.0966 9.30146 19.184 9.4683C19.2277 9.55176 19.2608 9.61849 19.2835 9.66569C19.2949 9.6893 19.3037 9.70804 19.3099 9.72157L19.3174 9.7379L19.3197 9.74306L19.3206 9.74487L19.3209 9.74558C19.321 9.74588 19.3211 9.74616 18.75 10C19.3211 10.2538 19.321 10.2541 19.3209 10.2544L19.3206 10.2551L19.3197 10.2569L19.3174 10.2621L19.3099 10.2784C19.3037 10.292 19.2949 10.3107 19.2835 10.3343C19.2608 10.3815 19.2277 10.4482 19.184 10.5317C19.0966 10.6985 18.9664 10.9328 18.7906 11.2119C18.4397 11.7692 17.9038 12.5113 17.1607 13.2544C15.6708 14.7443 13.3329 16.25 10 16.25C6.66714 16.25 4.3292 14.7443 2.83931 13.2544C2.09617 12.5113 1.5603 11.7692 1.20939 11.2119C1.03362 10.9328 0.903373 10.6985 0.815984 10.5317C0.772267 10.4482 0.739205 10.3815 0.716476 10.3343C0.705109 10.3107 0.696319 10.292 0.690066 10.2784L0.682582 10.2621L0.680256 10.2569L0.679445 10.2551L0.679127 10.2544C0.678993 10.2541 0.678868 10.2538 1.25 10C0.678868 9.74616 0.678993 9.74588 0.679127 9.74558L0.679445 9.74487L0.680256 9.74306L0.682582 9.7379L0.690066 9.72157C0.696319 9.70804 0.705109 9.6893 0.716476 9.66569C0.739205 9.61849 0.772267 9.55176 0.815984 9.4683C0.903373 9.30146 1.03362 9.06724 1.20939 8.78809C1.5603 8.23076 2.09617 7.4887 2.83931 6.74556ZM1.25 10L0.678868 9.74616C0.607044 9.90777 0.607044 10.0922 0.678868 10.2538L1.25 10ZM1.94882 10C2.02235 10.1377 2.12794 10.3248 2.26718 10.5459C2.58033 11.0433 3.06008 11.7074 3.72319 12.3706C5.0458 13.6932 7.08286 15 10 15C12.9171 15 14.9542 13.6932 16.2768 12.3706C16.9399 11.7074 17.4197 11.0433 17.7328 10.5459C17.8721 10.3248 17.9777 10.1377 18.0512 10C17.9777 9.86227 17.8721 9.67524 17.7328 9.4541C17.4197 8.95674 16.9399 8.29255 16.2768 7.62944C14.9542 6.30683 12.9171 5 10 5C7.08286 5 5.0458 6.30683 3.72319 7.62944C3.06008 8.29255 2.58033 8.95674 2.26718 9.4541C2.12794 9.67524 2.02235 9.86227 1.94882 10ZM18.75 10L19.3211 10.2538C19.393 10.0922 19.393 9.90777 19.3211 9.74616L18.75 10Z"
                fill="#A259FF" />
        ...
        <div class="cards-container">
          <div class="card">
            <div class="img-container">
              <img src="./images/Homepage/discover-more/card-1.png" alt="">
            </div>
            <div class="card-footer">
              <h5 class="card-heading">Distant Galaxy</h5>
              <div class="author">
                <img src="./images/Homepage/discover-more/avatar-1.png" alt="" class="avatar">
                <span class="name">MoonDancer</span>
              </div>
              <div class="price-bid">
                <div class="price-container">
                  <span class="title">Price</span>
                  <span class="price">1.63 ETH</span>
                </div>
                <div class="bid-container">
                  <span class="title">Highest Bid</span>
                  <span class="price">0.33 wETH</span>
                </div>
              </div>
            </div>
          </div>
          <div class="card">
            <div class="img-container">
              <img src="./images/Homepage/discover-more/card-2.png" alt="">
            </div>
            <div class="card-footer">
              <h5 class="card-heading">Life On Edena</h5>
              <div class="author">
                <img src="./images/Homepage/discover-more/avatar-2.png" alt="" class="avatar">
                <span class="name">NebulaKid</span>
              </div>
              <div class="price-bid">
                <div class="price-container">
                  <span class="title">Price</span>
          ...
          <div class="card">
            <div class="img-container">
              <img src="./images/Homepage/discover-more/card-3.png" alt="">
            </div>
            <div class="card-footer">
              <h5 class="card-heading">AstroFiction</h5>
              <div class="author">
                <img src="./images/Homepage/discover-more/avatar-3.png" alt="" class="avatar">
                <span class="name">Spaceone</span>
              </div>
              <div class="price-bid">
                <div class="price-container">
                  <span class="title">Price</span>
        ...
        <div class="section-content">
          <div class="nft-summary">
            <div class="artist-card">
              <img src="./images/Homepage/top-creators/avatar-7.png" alt="" class="avatar">
              <span class="name">Shroomie</span>
            </div>
            <h2 class="section-heading">Magic Mashrooms</h2>
            <div class="timeRemaining-card">
              ...
              <div class="card-content">
                ...
                <div class="time-container">
                  <div class="time"><span class="number">59</span><span class="txt">Hours</span></div>
                  <span class="divider">:</span>
                  <div class="time"><span class="number">59</span><span class="txt">Minutes</span></div>
                  <span class="divider">:</span>
                  <div class="time"><span class="number">59</span><span class="txt">Seconds</span></div>
                </div>
              </div>
            </div>
            <button class="btn-primary btn-seeNFT">
