            ...
            <div class="trendingCollection-content">
                ...
                <div class="collectionCards-container">
                    ...
                    <div class="collection-card">
                        ...
                        <div class="secondaryImg-container">
                            <img src="./images/Homepage/trending-section/mushroom-sub1.png" alt=""
                                class="secondary-img">
                            <img src="./images/Homepage/trending-section/mushroom-sub2.png" alt=""
                                class="secondary-img">
                            <div class="secondary-img full-collection">1025+</div>
                        </div>
                        <div class="card-footer">
                            ...
                            <div class="icon">
                                <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M51.9531 35.3906C57.246 38.3777 61.6223 42.754 64.6094 48.0469"
                                        stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </div>
                            ...
                            <div class="icon">
                                <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M81.25 31.25L31.25 43.75" stroke="white" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M31.25 79.6875V25L81.25 12.5V67.1875" stroke="white" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </div>
                        </div>
                            ...
                            <div class="icon">
                                <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M71.875 43.75L93.75 31.25V68.75L71.875 56.25" stroke="white"
                            ...
                            <div class="icon">
                                ...
                                <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                                    ...
                                    <path d="M75 59.375H93.75" stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M32.8125 15.625V31.25" stroke="white" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M25 23.4375H40.625" stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M65.625 71.875V84.375" stroke="white" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M59.375 78.125H71.875" stroke="white" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                        ...
                                        stroke="white" stroke-width="3" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M56.25 31.25L68.75 43.75" stroke="white" stroke-width="3"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
