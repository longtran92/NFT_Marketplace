...
<body>
  ...
  <main class="create-account-section">
      ...
      <div class="main-content">
        <div class="right-content">
          <div class="form-container">
            ...
            <span class="description">Welcome! enter your details and start creating, collecting and selling
              NFTs.</span>
            <form class='form' action="">
              <div class="input-container user-name">
              ...
              <button class="btn-createAccount">Create account</button>
            </form>
          </div>
        </div>
      </div>
